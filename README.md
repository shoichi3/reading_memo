...
ログインした後に本を追加する。そして、その本に関するメモを追加する。
...
ユースケース: 必須項目を入力すると、サインインまたはログインすることができる。また、ログアウトボタンを押すと、ログアウトすることができる。

## 本追加機能
目的: ユーザーが本を追加できるようにするため。
詳細: 本のタイトルを入力すると本を追加することができる。
ユースケース: 本を追加するというボタンを押すと、本のタイトルを追加することができる。

## メモ追加機能
目的: ユーザーがメモを追加できるようにするため。
詳細: メモする箇所とメモの内容を入力すると、メモを追加することができる。
ユースケース: メモ一覧ページでメモを追加するというボタンを押すと、メモに関する写真とメモの内容を追加することができる。

## 本の詳細表示機能
目的: その本に関するメモを一覧で表示するため。
詳細: その本に関するメモを一覧で表示することができる。
ユースケース: 本をクリックすると、その本に関連するメモを確認することができる。

## メモの詳細表示機能
目的: メモに関する情報を閲覧するため。
詳細: 選択したメモだけを画面に表示することができる。
ユースケース: メモをクリックすると、メモの詳細を閲覧することができる。

## 本削除機能
目的: 本を削除するため。
詳細: 指定した本を削除することができる。また、その本に関連するメモも削除することができる。
ユースケース: 削除ボタンを押すと、本を削除することができる。

## メモ削除機能
目的: メモを削除するため。
詳細: 指定したメモを削除することができる。
ユースケース: メモ詳細ページで削除ボタンを押すと、メモを削除することができる。

## 本のタイトル編集機能
目的: 本のタイトルを編集するため。
詳細: 本のタイトルを編集することができる。
ユースケース: メモ一覧ページの編集ボタンを押すと、本のタイトルを編集することができる。

## メモ編集機能
目的: メモを編集するため。
詳細: メモやメモに該当する写真を編集することができる。
ユースケース: メモ詳細ページで編集ボタンを押すと、メモの内容を変更することができる。
...
ユースケース: ページ上部にある検索ボックスでキーワードを検索し、それに関する本やメモを閲覧することができる。

## レスポンシブWebデザイン機能
目的: スマートフォンで気軽にメモをできるようにするため。
詳細: 画面の幅が変わった場合でも、ページが崩れないようにする。
ユースケース: パソコンでアプリを開いたときでも、スマホでアプリを開いたときでも整ったページで操作することができる。
...
本をクリックすると、その本に関するメモを表示することができる。
